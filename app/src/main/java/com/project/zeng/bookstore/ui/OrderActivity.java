    ...
    private void pay(){
        ...
        BP.pay(mSellerId, comment, getTotalPrice(), true, new PListener() {
            ...
            public void orderId(String s) {
                ...
                hideDialog();
                Log.e("OrderActivity", "orderId=" + newOrder.getOrderId());
            }
            ...
            public void fail(int i, String s) {
                if(i == -3){//-3：没有安装BmobPlugin的插件
                    ...
                    Toast.makeText(OrderActivity.this, "支付中断!", Toast.LENGTH_SHORT).show();
                }
                hideDialog();
            }
            ...
            @Override
            public void unknow() {
                Toast.makeText(OrderActivity.this, "支付结果未知,请稍后手动查询", Toast.LENGTH_SHORT).show();
                hideDialog();
            }
        });
        isClickPay = false;
